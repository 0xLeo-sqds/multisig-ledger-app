...
const USDC_MINT: [u8; 32] = [
    0xc6, 0xfa, 0x7a, 0xf3, 0xbe, 0xdb, 0xad, 0x39, 0x95, 0x86, 0x91, 0x9b, 0x22, 0x2b, 0x3f,
    0x60, 0xe2, 0x11, 0xf0, 0xbf, 0xbe, 0x38, 0x1a, 0x0a, 0x7c, 0x1c, 0x14, 0x0a, 0x62, 0xa6,
    0xf6, 0x12,
];
// USDT: Es9vMFrzaCERmJfrF4H2FYD4KCoNkY11McCe8BenwNYB
const USDT_MINT: [u8; 32] = [
    0xce, 0x01, 0x0e, 0x60, 0xaf, 0xea, 0xc5, 0xe2, 0xa4, 0x6c, 0x78, 0xd4, 0xb5, 0x88, 0x2f,
    0x7a, 0x1e, 0x2e, 0x0c, 0xac, 0x97, 0x63, 0xf2, 0x62, 0xa4, 0x78, 0x54, 0x19, 0x47, 0xf3,
    0xd3, 0xf3,
];
...
pub fn lookup_token(mint: &[u8; 32]) -> Option<TokenInfo> {
    match mint {
        m if *m == USDC_MINT => Some(TokenInfo { symbol: "USDC", decimals: 6 }),
        m if *m == USDT_MINT => Some(TokenInfo { symbol: "USDT", decimals: 6 }),
        _ => None,
    }
}
...
pub fn format_amount(raw: u64, decimals: u8) -> ArrayString<32> {
    ...
    if frac_part == 0 {
        ...
        let _ = write!(&mut frac_buf, "{:0>width$}", frac_part, width = decimals as usize);
