...
pub const JITO_STAKE_POOL: [u8; 32] = [
    ...
    0xe8, 0x4e, 0xa1, 0x5e, 0xfa, 0x1d, 0x44, 0xb7, 0x22, 0x93, 0xf6, 0xdb, 0xdb, 0x00, 0x16, 0x50,
];
...
pub fn is_known_program_for_review(program_id: &[u8; 32]) -> bool {
    programs::lookup_program(program_id).is_some()
}

pub fn is_fully_decoded_program_for_review(program_id: &[u8; 32]) -> bool {
...
#[allow(dead_code)]
pub fn describe_inner_instruction(
    msg: &ParsedMessage<'_>,
    ix: &InstructionMeta,
) -> ArrayString<64> {
    let mut desc = ArrayString::<64>::new();
